...
#define CAMERA_IMAGE_SIZE		30000

struct Camera_Struct
{
	bufferType *Camera_Buffer_debug_console_pt;
	bufferType Camera_Buffer_debug_console;
	bufferType *Camera_Buffer_Tx_pt;
	bufferType Camera_Buffer_Tx;
	bufferType *Camera_Buffer_Rx_pt;
	bufferType Camera_Buffer_Rx;
	bufferType **buffer;
