...
{
	camera->Camera_Buffer_Rx_pt = &camera->Camera_Buffer_Rx;
	camera->Camera_Buffer_debug_console_pt = &camera->Camera_Buffer_debug_console;
	camera->Camera_Buffer_Tx_pt = &camera->Camera_Buffer_Tx;
	buffer_init(camera->Camera_Buffer_Tx_pt, 100);
	buffer_init(camera->Camera_Buffer_debug_console_pt, 100);
	camera->camera_field_counter = 0;
